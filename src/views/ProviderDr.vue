<template>
<div>
    <section class="page-section" id="provider">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">Providers</h2>
                </div>
            </div>
            <div class="row row-cols-1 row-cols-md-2 g-4">
  <div class="col">
    <div class="card">
      <img src="../assets/Practitioners/1.png" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title">Doctors</h5>
                <p class="card-text">Coordinate with physicians from different specializations.</p>
       <a class="btn btn-primary"><router-link style="text-decoration: none; color: inherit;" to="/doctors1">Recommend a patient</router-link></a>
      </div>
    </div>
  </div>
    <div class="col">
    <div class="card">
      <img src="../assets/Practitioners/6.png" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title">Pharmacists</h5>
        <p class="card-text">Coordinate with Pharmacists for pharmacologic therapy to share. </p>
        <a class="btn btn-primary "><router-link style="text-decoration: none; color: inherit;" to="/pharmacists1">Recommend a patient</router-link></a>
      </div>
    </div>
  </div>
  <div class="col">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <a href="#" class="btn btn-primary disabled">Recommend a patient</a>
      </div>
    </div>
  </div>
  <div class="col">
