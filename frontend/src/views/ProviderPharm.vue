  ...
  <div class="col">
    <div class="card">
      ...
      <div class="card-body">
       ...
       <a class="btn btn-primary"><router-link style="text-decoration: none; color: inherit;" to="/doctors2">Recommend a patient</router-link></a>
      </div>
    </div>
  </div>
    <div class="col">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <a class="btn btn-primary "><router-link style="text-decoration: none; color: inherit;" to="/pharmacists2">Recommend a patient</router-link></a>
      </div>
    </div>
  </div>
  <div class="col">
