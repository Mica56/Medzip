    ...
    <div class="modal-content">
      <div class="modal-container">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Providers Sign Up</h5>
        ...
        <form class="row g-3 needs-validation" novalidate>
          ...
          <div class="mb-3">
            <input v-model="form.first_name" type="Name" class="form-control" id="exampleInputName1" placeholder="First Name" required>
              <div class="invalid-feedback">
              Please provide a valid first name.
            </div>
          </div>
          <div class="mb-3">
            <input v-model="form.last_name" type="Name" class="form-control" id="exampleInputName2" placeholder="Last Name" required>
            <div class="invalid-feedback">
          ...
          <div class="mb-3">
            <input v-model="form.birthday" type="Bday" class="form-control" id="exampleInputSex1" placeholder="Date of Birth MM/DD/YEAR" required>
            <div class="invalid-feedback">
          ...
          <div class="mb-3">
            ...
            <div class="mb-3">
             ...
             <div class="mb-3">
                <input v-model="form.prc_num" type="PRC License" class="form-control" id="exampleInputPRC1" placeholder="PRC Liscence Number" required>
                <div class="invalid-feedback">
            ...
            <div class="mb-3">
              <label for="formFile" class="form-label">Attach clear picture with PRC ID</label>
              <input @change="previewFiles" class="form-control" type="file" id="formFile" required>
              </div>
